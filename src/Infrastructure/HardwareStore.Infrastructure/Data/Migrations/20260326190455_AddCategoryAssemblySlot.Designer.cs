...
namespace HardwareStore.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260326190455_AddCategoryAssemblySlot")]
    partial class AddCategoryAssemblySlot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HardwareStore.Infrastructure.Models.Category", b =>
                {
                    ...
                    b.Property<int>("Group")
                        .HasColumnType("int")
                        .HasComment("hardware vs peripherals segment");
            ...
            modelBuilder.Entity("HardwareStore.Infrastructure.Models.Product", b =>
                {
                    ...
                    b.Property<string>("Options")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("product options json");
            ...
            modelBuilder.Entity("HardwareStore.Infrastructure.Models.ProductAssemblyComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("assembly component row id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int>("AssemblyProductId")
                        .HasColumnType("int")
                        .HasComment("assembled product id (parent)");

                    b.Property<int>("ComponentProductId")
                        .HasColumnType("int")
                        .HasComment("component product id");

                    b.Property<int>("Quantity")
                        .HasColumnType("int")
                        .HasComment("units of this component in the assembly");

                    b.Property<string>("Role")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasComment("component slot role label e.g. CPU, GPU");

                    b.Property<int>("SortOrder")
                        .HasColumnType("int")
                        .HasComment("display order within the assembly");
                    ...
                    b.ToTable("ProductAssemblyComponents", t =>
                        {
                            t.HasComment("product assembly bill of materials row");
                        });
                });
            ...
            modelBuilder.Entity("HardwareStore.Infrastructure.Models.ProductAssemblyComponent", b =>
                {
                    b.HasOne("HardwareStore.Infrastructure.Models.Product", "AssemblyProduct")
                        .WithMany("AssemblyComponents")
                        .HasForeignKey("AssemblyProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HardwareStore.Infrastructure.Models.Product", "ComponentProduct")
                        .WithMany("UsedInAssemblies")
